...
public class listaCuentas extends javax.swing.JFrame {
    ...
    public listaCuentas() {
        ...
        try 
        {
            ...
            while(rs.next())
            {
                modelo.addRow(new Object[]{rs.getString("Codigo"),rs.getString("Nombre"),rs.getString("Naturaleza")});
            }
            rs=st.executeQuery("Select * from TipoCuenta");
            while(rs.next())
            {
    ...
    private void jTextField1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyReleased
        ...
        try 
        {
            ResultSet rs=st.executeQuery("Select * from Cuentas WHERE (Codigo LIKE '%"+jTextField1.getText()+"%');");
            while(rs.next())
            {
                modelo.addRow(new Object[]{rs.getString("Codigo"),rs.getString("Nombre"),rs.getString("Naturaleza")});
            }
    ...
    private void jTextField2KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField2KeyReleased
        ...
        try 
        {
            ResultSet rs=st.executeQuery("Select * from Cuentas WHERE (Nombre LIKE '%"+jTextField2.getText()+"%');");
            while(rs.next())
            {
                modelo.addRow(new Object[]{rs.getString("Codigo"),rs.getString("Nombre"),rs.getString("Naturaleza")});
            }
    ...
    private void jComboBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jComboBox1ItemStateChanged
        ...
        try 
        {
            ...
            {
                ResultSet rs=st.executeQuery("Select * from Cuentas WHERE (Naturaleza LIKE '%"+jComboBox1.getSelectedItem().toString()+"%');");
                while(rs.next())
                {
                    modelo.addRow(new Object[]{rs.getString("Codigo"),rs.getString("Nombre"),rs.getString("Naturaleza")});
                }
